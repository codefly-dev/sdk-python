...
def test_environment_variable_endpoints():
    ...
    endpoint = codefly.endpoint(application="backend", service="server", name="rest", api="rest")
    ...
    endpoint = codefly.endpoint(application="backend", service="server", name="grpc", api="grpc")
    test(endpoint, address)
    ...
    endpoint = codefly.endpoint(application="backend", service="server", name="name", api="grpc")
    test(endpoint, address)
